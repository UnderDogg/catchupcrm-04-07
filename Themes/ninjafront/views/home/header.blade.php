            ...
            <ul class="sidebar-nav">
                ...
                <li style="width:100%;">
                    <div class="nav-footer">
                        ...
                        <a href="javascript:showKeyboardShortcuts()" target="_blank"
                           title="{{ trans('texts.keyboard_shortcuts') }}">
                                ...
                                @if (Utils::isOAuthEnabled())
                                    <div class="col-md-4 col-md-offset-1">
                                        ...
                                        @foreach (App\Services\AuthService::$providers as $provider)
                                            <a href="{{ URL::to('auth/' . $provider) }}"
                                               ...
                                               onclick="setSocialLoginProvider('{{ strtolower($provider) }}')"
                                    ...
                                    <center>
                                        <div id="errorTaken" style="display:none">
                                            &nbsp;<br/>{{ trans('texts.email_taken') }}</div>
                                    </center>
                                    <br/>
