...
<div id="upgrade-modal" class="container" style="">
    ...
    <div class="row">
        ...
        <div class="col-md-4 col-md-offset-2 text-center">
            ...
            <h3>$<span id="upgrade_pro_price">{{ PLAN_PRICE_PRO_MONTHLY }}</span> <span
                        class="upgrade_frequency">/ {{ trans('texts.plan_term_month') }}</span></h3>
        ...
        <div class="col-md-4 columns text-center">
            ...
            <p class="subhead">{{ trans('texts.pay_annually_discount') }}</p>
            <img width="65" src="{{ asset('images/pro_plan/border.png') }}"/>
            <h3>$<span id="upgrade_enterprise_price">{{ PLAN_PRICE_ENTERPRISE_MONTHLY_2 }}</span> <span
                        class="upgrade_frequency">/ {{ trans('texts.plan_term_month') }}</span></h3>
