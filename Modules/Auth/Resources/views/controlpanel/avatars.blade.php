...
@section('control-form')
    <p>This panel will let you assign your own avatar, at the moment we only support those that have been assigned by
        Gravatar or a Social login.</p>
    </div>
    </div>
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <label for="{{ $name }}">
                        <img src="{{ $avatar }}" alt="{{ $user->screenname }}'s {{ $name }} Avatar" class="thumbnail"
