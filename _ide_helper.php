 ...
 * Generated for Laravel 5.3.31 on 2017-04-01.
 *
...
namespace Illuminate\Support\Facades {
    ...
    class Auth {
         ...
         *
         * @return \Modules\Auth\Models\User|null 
         * @static 
         */
         ...
         * @param mixed $id
         * @param bool $remember
         * @return \Modules\Auth\Models\User|false 
         * @static 
         */
...
namespace Teepluss\Theme\Facades {
...
namespace BeatSwitch\Lock\Integrations\Laravel\Facades {
    ...
    class Lock {
         ...
         * @static 
         */
        public static function getAccountLock()
        {
            return \BeatSwitch\Lock\Integrations\Laravel\UserLock::getAccountLock();
        }
    ...
    class LockManager {
         ...
         * @static 
         */
        public static function caller($caller)
        {
            return \BeatSwitch\Lock\Manager::caller($caller);
        }
        ...
        {
            return \BeatSwitch\Lock\Manager::role($role);
        }
         ...
         * @static 
         */
        public static function makeCallerLockAware($caller)
        {
            return \BeatSwitch\Lock\Manager::makeCallerLockAware($caller);
        }
         ...
         * @static 
         */
        public static function makeRoleLockAware($role)
        {
            return \BeatSwitch\Lock\Manager::makeRoleLockAware($role);
        }
         ...
         * @static 
         */
        public static function alias($name, $actions)
        {
            return \BeatSwitch\Lock\Manager::alias($name, $actions);
        }
         ...
         * @static 
         */
        public static function setRole($names, $inherit = null)
        {
            return \BeatSwitch\Lock\Manager::setRole($names, $inherit);
        }
         ...
         * @static 
         */
        public static function convertRoleToObject($role)
        {
            return \BeatSwitch\Lock\Manager::convertRoleToObject($role);
        }
        ...
        public static function getDriver()
        {
            return \BeatSwitch\Lock\Manager::getDriver();
        }
        ...
        {
            return \BeatSwitch\Lock\Manager::getAliases();
        }
        ...
        {
            return \BeatSwitch\Lock\Manager::getRoles();
        }
...
namespace {
    ...
    class Lock extends \BeatSwitch\Lock\Integrations\Laravel\Facades\Lock {}
    
    class LockManager extends \BeatSwitch\Lock\Integrations\Laravel\Facades\LockManager {}
