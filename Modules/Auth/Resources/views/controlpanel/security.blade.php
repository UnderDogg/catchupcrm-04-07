...
@section('control-form')
    <p>This panel will let you control your security options whilst on this website. Each section is handled separately
        so ensure you hit the right submit button.</p>
    </div>
    </div>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            @if (!$user->hasEnabled2fa)
                ...
                <p>2 Factor Authentication is currently disabled. If you would like to enable it, use the button
                    below.</p>
            ...
            @else
                @if (!$user->require2fa)
                    <p>2 Factor Authentication requires a small bit of setting up before it can be used, follow
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="page-header">
                                <div class="page-title">
                                    <h3>Step 1
                                        <small>Scan the QR Code with your device.</small>
                                    </h3>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="page-header">
                                <div class="page-title">
                                    <h3>Step 2
                                        <small>Enter the code your device gives you to validate your 2fa is working.
                                        </small>
                                    </h3>
                                </div>
                            </div>
                ...
                @else
                    ...
                    <p>2 Factor Authentication is Enabled. This will only be used when you login directly (not using a
                        social media site).</p>
