...
namespace Modules\Quotations\Datatables;
...
class QuotationManager
{
    public function boot()
    {
        return [
             ...
             */
            'page' => [
                'title' => '<i class="fa fa-fw fa-puzzle-piece"></i> Quotation Manager',
                'alert' => [
                    'class' => 'info',
                    'text' => '<i class="fa fa-info-circle"></i> The Quotations',
                ],
                'header' => [
                    [
                        /*
                        'btn-text' => 'Check for Updates',
                        'btn-link' => 'admin.quotations.update',
            ...
            'options' => [
                ...
                'source' => null,
                'collection' => function () {
                    $model = 'Modules\Quotations\Models\Quotation';
            ...
            'columns' => [
                ...
                'quotation_number' => [
                    'th' => 'Number',
                    'tr' => function ($model) {
                        return array_get($model, 'quotation_number', null);
                    },
                    'orderable' => true,
                    'width' => '10%',
                ],
                ...
                */
                ...
                'actions' => [
                    ...
                    'tr' => function ($model) {
                        ...
                        $return[] = [
                            'btn-title' => 'View Quotation',
                            'btn-link' => route('admin.quotation.view', $model->id),
                        ...
                        $return[] = [
                            'btn-title' => 'Edit',
                            'btn-link' => route('admin.quotation.edit', $model->id),
