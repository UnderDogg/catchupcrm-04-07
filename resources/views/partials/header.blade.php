...
@section('head')
    ...
    <link href="{{ asset('themes/ninjafront/css/built.css') }}" rel="stylesheet" type="text/css"/>
    <style type="text/css">
...
@section('body')
    ...
    {{--{!! session(SESSION_LEFT_SIDEBAR) ? 'toggled-left' : '' !!} {!! session(SESSION_RIGHT_SIDEBAR, true) ? 'toggled-right' : '' !!}--}}
    <div id="wrapper" class=''>
            ...
            <ul class="sidebar-nav">
                ...
                <li style="width:100%;">
                    <div class="nav-footer">
                        <a href="javascript:showContactUs()" target="_blank" title="Contact Us">
                            <i class="fa fa-envelope"></i>
                        </a>
                        <a href="https://www.invoiceninja.com/forums/forum/support/" target="_blank"
                           title="Support Forum">
                            <i class="fa fa-list-ul"></i>
                        </a>
                        <a href="javascript:showKeyboardShortcuts()" target="_blank" title="Keyboard Shortcuts">
        ...
        <div id="right-sidebar-wrapper" class="hide-phone" style="overflow-y:hidden">
            <ul class="sidebar-nav">
                {{--{!! \App\Libraries\HistoryUtils::renderHtml(Auth::user()->account_id) !!}--}}Sort of BreadCrumb
            </ul>
        </div>
            ...
            <div class="modal fade" id="signUpModal" tabindex="-1" role="dialog" aria-labelledby="signUpModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div style="background-color: #fff; padding-right:20px" id="signUpDiv"
                             onkeyup="validateSignUp()" onclick="validateSignUp()" onkeydown="checkForEnter(event)">
                            <br/>
                            ...
                            <div class="row signup-form">
                                <div class="col-md-11 col-md-offset-1">
                                    {!! Former::checkbox('terms_checkbox')
                                        ->label(' ')
                                        ->value(1)
                                        ->text(trans('texts.agree_to_terms', ['terms' => '<a href="#" target="_blank">'.trans('texts.terms_of_service').'</a>']))
                                        ->raw() !!}
                                    <br/>
                                </div>
