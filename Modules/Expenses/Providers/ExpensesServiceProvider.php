...
class ExpensesServiceProvider extends ServiceProvider
{
    ...
    protected function registerConfig()
    {
        ...
        $this->mergeConfigFrom(
            __DIR__.'/../Config/config.php', 'expenses'
        );
    }
    ...
    {
        $viewPath = base_path('resources/views/modules/expenses');
        ...
        }, \Config::get('view.paths')), [$sourcePath]), 'expenses');
    }
    ...
    {
        $langPath = base_path('resources/lang/modules/expenses');
