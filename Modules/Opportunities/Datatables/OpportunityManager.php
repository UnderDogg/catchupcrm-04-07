...
namespace Modules\Opportunities\Datatables;
...
class OpportunityManager
{
    public function boot()
    {
        return [
             ...
             */
            'page' => [
                'title' => '<i class="fa fa-fw fa-puzzle-piece"></i> Opportunities Manager',
                'alert' => [
                    'class' => 'info',
                    'text' => '<i class="fa fa-info-circle"></i> The Opportunities',
                ],
                'header' => [
                    [
                        /*'btn-text' => 'Check for Updates',
                        'btn-link' => 'admin.opportunities.update',
            ...
            'options' => [
                ...
                'source' => null,
                'collection' => function () {
                    $model = 'Modules\Opportunities\Models\Opportunity';
            ...
            'columns' => [
                ...
                'email' => [
                    'th' => 'Email',
                    'tr' => function ($model) {
                        return array_get($model, 'email', null);
                    },
                    'orderable' => true,
                    'searchable' => true,
                    'width' => '7%',
                ...
                'phonenumber' => [
                    'th' => 'Phone Number',
                    'tr' => function ($model) {
                        return array_get($model, 'phonenumber', null);
                    },
                    'orderable' => true,
                    'searchable' => true,
                    'width' => '7%',
                ...
                'status' => [
                    'th' => 'Status',
                    'tr' => function ($model) {
                        return array_get($model, 'status', null)
                ...
                'actions' => [
                    ...
                    'tr' => function ($model) {
                        ...
                        $return[] = [
                            ...
                            'btn-link' => route('admin.opportunity.view', $model->id),
                        ...
                        $return[] = [
                            'btn-title' => 'Edit',
                            'btn-link' => route('admin.opportunity.edit', $model->id),
