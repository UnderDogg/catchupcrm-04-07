                ...
                <div class="panel-body">
                    ...
                    @else
                        ...
                        <button class="btn-labeled btn btn-success" type="submit"
                                data-confirm="Are you sure you want to disable 2FA for this user?">
        ...
        @if (config('cms.auth.config.users.expire_passwords', false))
            <div class="col-md-6">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="alert alert-info"><strong>Information: </strong> Using this option, will force the
                            user to reset their password upon next login.
                        </div>
                        {!! Former::horizontal_open(route('admin.user.expirepassword', $user->id)) !!}
                        <button class="btn-labeled btn btn-success" type="submit"
                                data-confirm="Are you sure you want to expire this users password?">
