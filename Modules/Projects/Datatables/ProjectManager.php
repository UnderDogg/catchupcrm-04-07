...
class ProjectManager
{
    public function boot()
    {
        return [
             ...
             */
            'page' => [
                'title' => '<i class="fa fa-fw fa-puzzle-piece"></i> Project Manager',
                'alert' => [
                    'class' => 'info',
                    'text' => '<i class="fa fa-info-circle"></i> The Projects',
                ],
                'header' => [
                    [
                        /*
                        'btn-text' => 'Check for Updates',
                        'btn-link' => 'admin.projects.update',
            ...
            'options' => [
                ...
                'source' => null,
                'collection' => function () {
                    $model = 'Modules\Projects\Models\Project';
            ...
            'columns' => [
                ...
                'project_number' => [
                    'th' => 'Number',
                    'tr' => function ($model) {
                        return array_get($model, 'project_number', null);
                    },
                    'orderable' => true,
                    'width' => '10%',
                ],
                ...
                'name' => [
                    'th' => 'Name',
                    'tr' => function ($model) {
                        return array_get($model, 'project_name', null);
                    },
                    'orderable' => true,
                    'searchable' => true,
                    'width' => '35%',
                ...
                'actions' => [
                    ...
                    'tr' => function ($model) {
                        ...
                        $return[] = [
                            ...
                            'btn-link' => route('admin.project.view', $model->id),
                        ...
                        $return[] = [
                            'btn-title' => 'Edit',
                            'btn-link' => route('admin.project.edit', $model->id),
