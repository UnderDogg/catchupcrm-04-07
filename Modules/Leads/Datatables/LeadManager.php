...
class LeadManager
{
    public function boot()
    {
        return [
             ...
             */
            'page' => [
                'title' => '<i class="fa fa-fw fa-puzzle-piece"></i> Leads Manager',
                'alert' => [
                    'class' => 'info',
                    'text' => '<i class="fa fa-info-circle"></i> The Leads',
                ],
                'header' => [
                    [
            ...
            'options' => [
                ...
                'source' => null,
                'collection' => function () {
                    $model = 'Modules\Leads\Models\Lead';
                ...
                'actions' => [
                    ...
                    'tr' => function ($model) {
                        ...
                        $return[] = [
                            ...
                            'btn-link' => route('admin.lead.view', $model->id),
                        ...
                        $return[] = [
                            'btn-title' => 'Edit',
                            'btn-link' => route('admin.lead.edit', $model->id),
